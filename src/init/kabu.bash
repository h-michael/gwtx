...
if [[ ";${PROMPT_COMMAND:-};" != *";__kabu_prompt_hook;"* ]]; then
  if [[ "$(declare -p PROMPT_COMMAND 2>/dev/null)" == "declare -a"* ]]; then
    PROMPT_COMMAND=(__kabu_prompt_hook "${PROMPT_COMMAND[@]}")
  elif [[ -n "${PROMPT_COMMAND:-}" ]]; then
    PROMPT_COMMAND="__kabu_prompt_hook;${PROMPT_COMMAND}"
  else
    PROMPT_COMMAND="__kabu_prompt_hook"
  fi
fi
